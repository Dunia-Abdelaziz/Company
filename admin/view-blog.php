...
<div class="container py-5">
        <div class="row">
            ...
            <div class="col-md-6 offset-md-3">
                <h3 class="mb-3">View blog details</h3>
                <div class="card">
                    ...
                    ?>
                        ...
                        enctype = "multipart/form-data" >
                            ...
                            <div class="form-group">
                              ...
                              <textarea type="text" name="s_desc"  class="form-control" disabled><?= $blog["short_description"]?></textarea>
                            </div>


                            <div class="form-group">
                              <label>long description</label>
                              <textarea type="text" name="l_desc" class="form-control" disabled><?= $blog["long_description"]?> </textarea>
                            </div>
                            ...
                            <div class="custom-file">
                                <input type="file"  name="img" class="custom-file-input" id="customFile" disabled>
                                <label class="custom-file-label" for="customFile">Choose Image</label>
                            </div>
                            
                            <div class="mt-3" >
                                <img class ="img-fluid d-block m-auto" style= "height:100px"src ="uploud/blogs/<?=$blog['image'] ?>" disabled>
                            </div>
